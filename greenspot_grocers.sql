...
--
-- Host: 127.0.0.1    Database: greenspot_grocers
-- ------------------------------------------------------
...
INSERT INTO `items` VALUES (1000,'Bennet Farm free-range eggs','Dairy','dozen','D12',17,'Vendor1'),(1100,'Freshness White beans','Canned','12 oz can','A2',26,'Vendor2'),(1222,'Freshness Green beans','Canned','12 oz can','A3',28,'Vendor2'),(1223,'Freshness Green beans','Canned','36 oz can','A7',15,'Vendor2'),(1224,'Freshness Wax beans','Canned','12 oz can','A3',15,'Vendor2'),(2000,'Ruby\'s Kale','Produce','bunch','P12',21,'Vendor3'),(2001,'Ruby\'s Organic Kale','Produce','bunch','PO2',22,'Vendor3');
...
CREATE TABLE `purchases` (
  ...
  `transaction_type` varchar(45) DEFAULT 'Purchase',
...
INSERT INTO `purchases` VALUES ('P-1','Vendor1',1000,'2022-02-01 00:00:00',25,2.35,'Purchase'),('P-2','Vendor2',1100,'2022-02-02 00:00:00',40,0.69,'Purchase'),('P-3','Vendor2',1222,'2022-02-10 00:00:00',40,0.59,'Purchase'),('P-4','Vendor2',1223,'2022-02-10 00:00:00',10,1.75,'Purchase'),('P-5','Vendor2',1223,'2022-02-15 00:00:00',10,1.80,'Purchase'),('P-6','Vendor2',1224,'2022-02-10 00:00:00',30,0.68,'Purchase'),('P-7','Vendor2',2000,'2022-02-12 00:00:00',25,1.29,'Purchase'),('P-8','Vendor3',2001,'2022-02-12 00:00:00',20,2.19,'Purchase');
...
CREATE TABLE `sales` (
  ...
  `transaction_type` varchar(45) DEFAULT 'Sale',
  PRIMARY KEY (`sale_id`),
...
INSERT INTO `vendors` VALUES ('Vendor1','Bennet Farms','Rt. 17','Evansville','IL','55446'),('Vendor2','Freshness, Inc.','202 E. Maple St.','St. Joseph','MO','45678'),('Vendor3','Ruby Redd Produce, LLC','1212 Milam St.','Kenosha','AL','34567');
...
-- Dump completed on 2025-01-07 20:33:23
